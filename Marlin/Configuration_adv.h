 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        200 // Seconds
...
#define NUM_Z_STEPPER_DRIVERS 2   // (1-4) Z options change based on how many
  ...
  #define Z_MULTI_ENDSTOPS
    ...
    #define Z2_USE_ENDSTOP        _ZMIN_ // CHANGED FROM _ZMAX_
...
#define TX_BUFFER_SIZE 128 // CHANGED FROM 0 
 ...
 */
  ...
  #if AXIS_IS_TMC(Y)
    #define Y_CURRENT       900 // CHANGED FROM 900
